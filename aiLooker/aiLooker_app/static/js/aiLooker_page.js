  ...
  return (
    <div onKeyDown={keyDownHandler}>
            ...
            <div className="modal-body">
              ...
              <div className="form-group" >
                {/* <input type="text" className="form-control" placeholder="광고유형"
                        ...
                        name="advttpcd" /> */}
                <select name="advttpcd" onChange={changeAdvt}>
                  <option value="none" selected disables hidden>광고유형</option>
              ...
              <div className="form-group">
                ...
                <select name="advtgrdcd" onChange={changeAdvt}>
                  <option value="none" selected disables hidden>광고등급</option>
                  <option value="01">01</option>
                  <option value="02">02</option>
                  <option value="03">03</option>
                </select>
      ...
      <div style={{maxWidth: "1000px", margin: "auto", marginTop: "1em", marginBottom: "1em",
        ...
        <div style={{display: "flex", flexDirection: "row", textalign: "center", fontsize: "2rem", textdecoration: "underline"}}>
          <span>[001-광고관리]</span>
          ...
          <table style={{width: "100%" }}>
            ...
            <tbody>
              ...
              <tr>
                <td>시작일자</td>
                <td>
                  <input type="date" className="form-control" name="advtstadate"
                    value={search.advtstadate} onChange={changeSearch}
                    placeholder="YYYYMMDD"/>
                </td>
                <td>종료일자</td>
                <td>
                  <input type="date" className="form-control" name="advtenddate"
              ...
              <tr>
                ...
                <td>
                  {/* <input type="text" className="form-control" name="advtgrdcd"
                    ...
                    placeholder="광고유형"/> */}
                  <select name="advttpcd" onChange={changeSearch}>
                    <option value="none" selected disables hidden>광고유형</option>
                    <option value="01">01</option>
                    <option value="02">02</option>
                    <option value="03">03</option>
                ...
                <td>
                  {/* <input type="text" className="form-control" name="advttpcd"
                    ...
                    placeholder="광고등급"/> */}
                  <select name="advtgrdcd" onChange={changeSearch}>
                    <option value="none" selected disables hidden>광고등급</option>
                    <option value="01">01</option>
                    <option value="02">02</option>
                    <option value="03">03</option>
